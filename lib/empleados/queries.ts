...
const COLS =
  "id,cedula,nombre,email,must_change_password,rol,lider_id,cargo,caja_compensacion,fecha_ingreso,fecha_egreso,particularidades,estado,tipo_vinculacion,convenio_path,fecha_fin_probable,creado_en,actualizado_en"
