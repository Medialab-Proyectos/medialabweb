...
import {
  Car, MapPin, Navigation, ShieldCheck, Clock, Zap,
...
export function MovilidadContent() {
  ...
  return (
    <main id="main-content">
      <Navbar />
      <StickyIndustryBreadcrumb pageEs="Movilidad" pageEn="Mobility" />

      {/* Hero */}
      <section className="relative pt-6 pb-20 px-6 bg-[var(--surface-dark)] text-white overflow-hidden" aria-labelledby="mov-h1">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold border w-fit"
            ...
            <Navigation size={14} /> {t("Movilidad sin fricción by MediaLab", "Frictionless mobility by MediaLab")}
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-2">
            ...
            <Link href={localized("/servicios/diseno-ux-ui")} className="w-full sm:w-auto inline-flex items-center gap-2 px-6 py-4 rounded-full text-sm font-medium border border-white/15 text-white/75 hover:text-white hover:border-white/30 transition-all">
        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-3 text-sm text-muted-foreground pt-2">
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Valida tu producto de movilidad con ", "Validate your mobility product with ")}
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Diseña interfaces para el movimiento con ", "Design interfaces for motion with ")}
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Construye tu app con ", "Build your app with ")}
