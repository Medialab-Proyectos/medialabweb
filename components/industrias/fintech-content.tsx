...
import {
  ShieldCheck, Eye, HandCoins, Gauge, CheckCircle2,
...
export function FintechContent() {
  ...
  return (
    <main id="main-content">
      <Navbar />
      <StickyIndustryBreadcrumb pageEs="Fintech" pageEn="Fintech" />

      {/* Hero */}
      <section className="relative pt-6 pb-20 px-6 bg-[var(--surface-dark)] text-white overflow-hidden" aria-labelledby="fintech-h1">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold border w-fit"
            ...
            <ShieldCheck size={14} /> {t("Diseño de confianza by MediaLab", "Trust design by MediaLab")}
          </div>
        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-3 text-sm text-muted-foreground pt-2">
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Profundiza en ", "Dive into ")}
                <Link href={localized("/blog/ux-fintech")} className="text-[var(--magenta)] font-medium underline decoration-[var(--magenta)]/30 hover:decoration-[var(--magenta)] transition-colors">{t("UX en Fintech: diseñar para la confianza", "UX in Fintech: designing for trust")}</Link>
              </span>
            </li>
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Valida tu producto financiero con ", "Validate your financial product with ")}
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Diseña experiencias financieras con ", "Design financial experiences with ")}
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Optimiza tu conversión con ", "Optimize your conversion with ")}
