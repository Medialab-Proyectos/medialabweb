...
import {
  GraduationCap, Trophy, Repeat, Users, BookOpen, Gauge,
...
export function EducacionContent() {
  ...
  return (
    <main id="main-content">
      <Navbar />
      <StickyIndustryBreadcrumb pageEs="Educación" pageEn="Education" />

      {/* Hero */}
      <section className="relative pt-6 pb-20 px-6 bg-[var(--surface-dark)] text-white overflow-hidden" aria-labelledby="edu-h1">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold border w-fit"
            ...
            <GraduationCap size={14} /> {t("Aprendizaje que transforma by MediaLab", "Transformative learning by MediaLab")}
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-2">
            ...
            <Link href={localized("/portafolio")} className="w-full sm:w-auto inline-flex items-center gap-2 px-6 py-4 rounded-full text-sm font-medium border border-white/15 text-white/75 hover:text-white hover:border-white/30 transition-all">
        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-3 text-sm text-muted-foreground pt-2">
            <li className="flex items-start gap-2.5">
              ...
              <span>
                {t("Mira plataformas reales en nuestro ", "See real platforms in our ")}
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Valida tu plataforma con ", "Validate your platform with ")}
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Diseña experiencias que retienen con ", "Design experiences that retain with ")}
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Construye tu plataforma con ", "Build your platform with ")}
