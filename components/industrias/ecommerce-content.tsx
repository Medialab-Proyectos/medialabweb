...
import {
  ShoppingCart, Search, CreditCard, Repeat, Heart, Gauge,
...
export function EcommerceContent() {
  ...
  return (
    <main id="main-content">
      <Navbar />
      <StickyIndustryBreadcrumb pageEs="E-commerce" pageEn="E-commerce" />

      {/* Hero */}
      <section className="relative pt-6 pb-20 px-6 bg-[var(--surface-dark)] text-white overflow-hidden" aria-labelledby="ecom-h1">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold border w-fit"
            ...
            <ShoppingCart size={14} /> {t("Conversión inteligente by MediaLab", "Smart conversion by MediaLab")}
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mt-2">
            ...
            <Link href={localized("/servicios/cro-saas")} className="w-full sm:w-auto inline-flex items-center gap-2 px-6 py-4 rounded-full text-sm font-medium border border-white/15 text-white/75 hover:text-white hover:border-white/30 transition-all">
        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-3 text-sm text-muted-foreground pt-2">
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Aumenta tu tasa de conversión con ", "Boost your conversion rate with ")}
                <Link href={localized("/servicios/cro-saas")} className="text-[var(--magenta)] font-medium underline decoration-[var(--magenta)]/30 hover:decoration-[var(--magenta)] transition-colors">{t("Optimización de Conversión (CRO)", "Conversion Optimization (CRO)")}</Link>
              </span>
            </li>
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Rediseña la experiencia de compra con ", "Redesign the shopping experience with ")}
            ...
            <li className="flex items-start gap-2.5">
              <ArrowRight size={14} className="shrink-0 mt-0.5 text-[var(--magenta)]" />
              <span>
                {t("Escala tu tienda con ", "Scale your store with ")}
