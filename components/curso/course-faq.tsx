...
export function CourseFaq() {
  ...
  const faqs = [
    ...
    { q: t("¿Cuándo empieza?", "When does it start?"), a: t("Cohorte 01 se anuncia pronto. Únete a la waitlist para acceso anticipado y precio de fundadores.", "Cohort 01 is announced soon. Join the waitlist for early access and founders' price.") },
