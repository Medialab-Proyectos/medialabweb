...
/**
 * Hero del PORTAL del especial (/mundial-2026). Presenta el Mundial como contexto
 * —escala, audiencia, sedes— y enmarca qué hace el especial. Theme-aware: en modo
 * claro usa fondo claro y texto oscuro (sin imagen de fondo); en oscuro mantiene el
 * fondo oscuro. Bilingüe, mobile-first.
 */
