      ...
      <div className="relative w-full h-[420px] md:h-[520px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12 max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 mt-4 text-white/60 text-sm">
            ...
            <span className="flex items-center gap-1"><Clock size={13} /> 6 min de lectura</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 pb-20">
        <div className="rounded-2xl border border-border p-8 flex flex-col md:flex-row items-center gap-6 bg-card">
          <div className="flex-1">
            <h3 className="font-display font-bold text-xl text-foreground mb-2">¿Estás construyendo un producto financiero?</h3>
            <p className="text-sm text-muted-foreground">Nuestro equipo tiene experiencia comprobada en UX para fintech. Conversemos.</p>
          </div>
