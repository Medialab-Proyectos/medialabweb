...
export const metadata: Metadata = {
  title: { absolute: "El ADN del Significado | MediaLab" },
  description:
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="relative w-full h-[420px] md:h-[520px] overflow-hidden">
        <Image src="/images/blog-adn-del-significado.jpg" alt="Equipo colaborando en el propósito y significado de un producto digital" fill className="object-cover" priority sizes="100vw" />
